...
class PaymentFacade:
    @staticmethod
    def process_payment(payment_type: str, payment_request: PaymentRequest, order: dict):
...
class OrderAdapter:
    ...
    def adapt(order_response):
        # Адаптация ответа сервиса заказов, если необходимо изменить структуру данных
